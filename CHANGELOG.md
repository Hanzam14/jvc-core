...
- Security reporting now points at the live private vulnerability reporting route (`SECURITY.md`).
- README/provenance updated with the public repository location and Apache-2.0 status. No code changes.
